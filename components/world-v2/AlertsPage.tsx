 ...
 *
 * Saiu de `/weather`, que era um DESTINO paralelo na barra global: alertas em
 * duas telas, com duas linguagens visuais, e nenhuma das duas dona do assunto.
 * Alerta é o que está acontecendo ao redor — assunto do MUNDO, e agora
 * sub-rota dele.
 *
...
export default function AlertsPage() {
  ...
  /*
   * A faixa entra nos DOIS ramos de retorno.
   *
   * Em NAV-T04 este mesmo descuido deixou `PlanPage` sem navegação no caminho
   * de quem não tem círculo: um beco sem saída que só existia para quem tinha
   * MENOS dado. Quem não deu permissão de localização cai aqui — e é
   * justamente quem mais precisa de uma saída com nome.
   */
