  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <title>Ficha de Emergência — {ficha.name}</title>
      ...
      <body>
        <div className="card">
          <div className="header">
            <div className="sos">⚠ FICHA DE EMERGÊNCIA — EOS</div>
          ...
          <div className="body">
            ...
            <div className="row">
              <div className="field">
                ...
                {ficha.blood_type
                  ...
                  : <div className="value" style={{color:'#444'}}>Não informado</div>}
              </div>
            </div>
            ...
            {ficha.medical_notes && (
              <div>
                <div className="label">Condições Médicas</div>
            ...
            {(ficha.medications ?? []).length > 0 && (
              <div>
                <div className="label">💊 Medicamentos em uso</div>
            ...
            {(ficha.emergency_contact_name || ficha.emergency_contact_phone) && (
              <div className="contact">
                <div className="label">Contato de Emergência</div>
