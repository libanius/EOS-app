    ...
    <main style={styles.page}>
      <section style={styles.container}>
        ...
        {/*
          ...
          o Simulador RECONFIGURA o app inteiro — `SimulationProvider` é global e
          já muda todo número que a pessoa vê. Isso é MODO, não lugar.

          Esta porta é a ponte até NAV-T08 transformá-lo em modo de verdade. O
          card do dashboard continua sendo a entrada principal; aqui está a
          entrada de quem procura pelo nome.
        */}
