...
| EXEC-T04 | Playbook por papel offline-first | NOT STARTED | Próxima ação do usuário no topo, protocolo como primeiro passo, carta do dependente como citação, rumo/distância/minutos sem tiles. D-214: brilho máximo real fica para Native futuro; PWA só aplica legibilidade e números ampliados. |
