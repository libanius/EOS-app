...
| PREP-T11 | Checklist para de sobrescrever o estoque da casa | **PENDING — EXECUTA PRIMEIRO** | 2026-08-12 — D-156. Marcar um item **nunca** sobrescreve `resource_inventory`. Autonomia lê o que está em CASA. Perda de dado acontecendo hoje: 20 L viram 4 L ao marcar um item de 4 L. Aceitação binária: (1) marcar item de 4 L numa casa com 20 L mantém 20 L; (2) teste automatizado prova isso; (3) sem migração |
