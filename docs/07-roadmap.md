...
| PREP-T10b | Escrita dupla | PENDING | Estágio 3 de `docs/37` §28. Depende de T10 |
| PREP-T10c | Backfill (com simulação a seco antes) | PENDING | Estágio 4. Reversível e re-executável sem duplicar. **Exige dry-run revisado antes de rodar** |
| PREP-T10d | Cutover | PENDING | Estágio 5. Explícito, decidido, uma tarefa. Primeiro passo irreversível da frente |
