...
| MAP-T10 | A grade global do vento é 900x mais grossa que a local | PENDING — **decisão do dono** | `25×25` sobre o mundo = uma leitura a cada **1.598 km**; local, a mesma grade dá **1,8 km**. Tudo entre os pontos globais é interpolação, e é por isso que de longe o campo parece liso e "fake" enquanto de perto coincide com o radar de chuva. Subir a grade melhora a fidelidade e **piora a latência** — que foi queixa do mesmo dono no mesmo dia. Precisa de escolha: mais fiel e mais lento, ou buscar grade grossa primeiro e refinar depois (duas idas, primeira pintura rápida) |
