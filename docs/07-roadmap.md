...
| PREP-T14 | Briefing de IA precisa gerar ação, não texto | PENDING | 2026-08-13 — achado do dono: depois da análise, o briefing **não gera CTA**. Viola a regra 1 do D-085 (*"preparação é acionável ou não pertence aqui"*). `next_steps` deve virar requisito confirmável, com `provenance`, pelo mesmo contrato de Pilot/EDU/simulação (D-093/D-119/D-092). Tarefa própria: muda contrato de saída da IA e envolve escrita persistente |
