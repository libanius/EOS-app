...
| EXEC-T05 | Estado compartilhado e encerramento | IN PROGRESS | Estados com idade, dependentes `sem aparelho`, escalonamento sugerido por `family_plan_triggers.escalation_minutes` (D-215) e encerrar como resolvida/cancelada. |
