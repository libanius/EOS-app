...
| PREP-T11 | Checklist para de sobrescrever o estoque + água em galão | **PENDING — EXECUTA PRIMEIRO** | 2026-08-12 — D-156 + D-158. Aceitação binária: (1) marcar item de 4 gal numa casa com 20 gal mantém 20 gal; (2) teste automatizado prova isso; (3) água exibida em galão em Preparação, Pilot, veredito e debrief; (4) `WATER_PER_PERSON_DAY` deixa de ter 3 cópias; (5) **armazenamento continua em litros** — `water_liters` só é renomeado na migração de PREP-T04; (6) sem migração, sem mudança de rota |
| PREP-T12 | Decidir a constante de água: 3 L ou 1 galão FEMA | PENDING — **decisão do dono, antes de PREP-T11** | 2026-08-12 — D-158 deixou aberto. EOS usa 3 L/pessoa/dia; FEMA usa 1 gal = 3,785 L. Adotar a FEMA corta ~21% da autonomia exibida de todo usuário (5 dias viram 4). Decisão de produto, não refatoração |
