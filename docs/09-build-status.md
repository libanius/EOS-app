...
| **Current Task** | **EXEC-T03 — `family_plan_executions` + disparo por gesto.** NOT STARTED — migration bloqueante da EXEC-T02 aplicada e verificada; próxima implementação pode começar. |
