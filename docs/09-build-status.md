...
| **Last Completed Task** | **D-080 / PLAN-T09 — múltiplos planos, execução cancelável e passos editáveis (2026-07-31)** |
...
| **Plano múltiplo** | ✅ PLAN-T09: o círculo pode ter vários planos ativos; `/plan` alterna/cria planos por nome, o executor escolhe qual plano rodar, passos fixos do EOS saem da lista numerada e há cancelar/falso alarme. Migration pendente de aplicação: `20260731000000_multiple_family_plans.sql` remove o índice antigo de plano ativo único. |
| **Pilot** | ✅ `npm run test:pilot` **5/5** com o MODELO real (2026-07-31): orbe fora do dashboard sem duplicar no dashboard, clima com números sem negar acesso, ciclone citado E qualificado, e análise de atividade com veredito, números e janela. |
