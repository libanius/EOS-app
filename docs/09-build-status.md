...
| **Build** | ✅ WV2-T15 follow-up validado em 2026-08-10 com `npm run type-check`, `npm test -- --runInBand` (202/202), `npm run build`, `npm run test:weather` (8/8; zoom global `17x17`, 378000 px escalares, 1833 partículas, `wrapsWorld=true`). |
