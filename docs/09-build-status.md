...
| **Current Task** | **EXEC-T06 — Promoção de ponto do dia + basemap persistente.** NOT STARTED — EXEC-T05 aplicada e verificada; não iniciar sem ler `specs/PLAN-EXEC-001-execucao-de-plano.md` seção EXEC-T06. |
