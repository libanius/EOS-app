...
| **⚠️ Migration pendente** | `20260728010000_simulation_join_token.sql` — link de convite do treino (D-072). Até aplicar, iniciar simulação com círculos selecionados falha ao gravar. |
