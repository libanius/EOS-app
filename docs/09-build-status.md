...
| **Last Completed Task** | **D-138 / NAV-T02 — Links da BottomNav voltam a navegar quando há badge (2026-08-08)** |
...
| **Next Task** | Roadmap sem tarefa `PENDING/IN PROGRESS` após NAV-T02; próxima frente precisa ser promovida explicitamente no Spine antes de código. |
| **Build** | ✅ NAV-T02 validado em 2026-08-08 com `npm run type-check`, `npm test -- --runInBand` (202/202), `npm run build` e `git diff --check`. |
