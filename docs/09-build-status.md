...
| **Migration** | ⏳ `20260804010000_circle_family_access.sql` pendente de aplicação pelo dono. Adiciona `family_access_status` em `circle_members` para separar membro do círculo de Família íntima. |
...
| **Next Task** | Operacional: aplicar `20260804010000_circle_family_access.sql`. Depois, membros pedem "Família íntima" na tela Círculos e Admin aprova antes do Pilot ler ficha master de co-membro. |
