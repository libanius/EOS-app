...
| **Current Task** | **EXEC-T03 — `family_plan_executions` + disparo por gesto.** NOT STARTED — não iniciar até aplicar `20260819050556_exec_t02_plan_sessions.sql`. |
...
| | **EXEC-T02 — `plan_sessions` + armar/desarmar (2026-08-19, migração pendente)** |
...
| **Migration** | ⏳ `20260819050556_exec_t02_plan_sessions.sql` criada em 2026-08-19. Pendente aplicar pelo dono no Supabase para liberar sessões armadas. |
...
| **Next Task** | **Aplicar `20260819050556_exec_t02_plan_sessions.sql` no Supabase; depois EXEC-T03.** |
