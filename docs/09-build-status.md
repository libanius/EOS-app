...
| **Clima** | ✅ `npm run test:weather` **8/8** com dado AO VIVO (2026-07-31): ciclone com posição/rumo, geometria oficial do NHC, vento em grade, painel de camadas persistente, setas RENDERIZADAS no mapa, o alerta pulsando na cor do risco, e a tempestade tocável levando a câmera até ela. O teste PROCURA uma região com alerta ativo no feed do NWS em vez de depender do tempo em Parkland. |
