...
| **Clima** | ✅ `npm run test:weather` **7/7** com dado AO VIVO (2026-07-31): ciclone com posição/rumo, geometria oficial do NHC, vento em grade, painel de camadas persistente e setas RENDERIZADAS no mapa. |
