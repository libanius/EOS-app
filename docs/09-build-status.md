...
| **Last Completed Task** | **D-077 — controle do círculo (papel/renomear/excluir), acesso ao plano, gatilhos e temporizador de simulação (2026-07-31)** |
...
| **In Progress** | — |
| **Fases pedidas pelo dono (2026-07-31)** | 1. Camadas de clima no mapa + rastreio de tempestade/furacão em tempo real (ventos, direção, clicar no alerta e ver onde está). 2. Reinventar a aba Família no design system da v2, com componentes dinâmicos. 3. WV2-T05 (a11y/perf), PLAN-T07 (Pilot propõe plano). |
