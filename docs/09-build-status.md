...
| **Next Task** | Roadmap sem tarefa `PENDING/IN PROGRESS` após D-118 e validação de `edu_view_count`; próxima frente precisa ser promovida explicitamente no Spine antes de código. |
