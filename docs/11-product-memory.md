...
- Page translation is being migrated incrementally under P1-T05; all authenticated product screens now consume the shared dictionary. Remaining surfaces are auth, landing, and the public Emergency Card.
